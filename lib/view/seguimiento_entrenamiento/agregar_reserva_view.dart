...
class AgregarReservaView extends StatefulWidget {
  final DateTime date;
  const AgregarReservaView({super.key, required this.date});

  @override
  State<AgregarReservaView> createState() => _AgregarReservaViewState();
}

class _AgregarReservaViewState extends State<AgregarReservaView> {
  @override
